interface Env { DB:D1Database; MEDIA:R2Bucket; ASSETS:Fetcher; DEV_ADMIN_TOKEN?:string; TEST_SITE_PASSWORD?:string; TEST_SITE_USER?:string; FFF_API_BASE:string; FFF_CLUB_NO:string; FFF_CLUB_CODE:string; DISTRICT_FAL_URL?:string; INSTAGRAM_ACCESS_TOKEN?:string; INSTAGRAM_USER_ID?:string }
